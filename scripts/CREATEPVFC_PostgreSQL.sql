DROP TABLE Uses_T CASCADE;
DROP TABLE WorksIn_T CASCADE;
DROP TABLE WorkCenter_T CASCADE;
DROP TABLE DoesBusinessIn_T CASCADE;
DROP TABLE EmployeeSkills_T CASCADE;
DROP TABLE Supplies_T CASCADE;
DROP TABLE ProducedIn_T CASCADE;
DROP TABLE OrderLine_T CASCADE;
DROP TABLE Product_T CASCADE;
DROP TABLE ProductLine_T CASCADE;
DROP TABLE Order_T CASCADE;
DROP TABLE Salesperson_T CASCADE;
DROP TABLE Vendor_T CASCADE;
DROP TABLE Skill_T CASCADE;
DROP TABLE RawMaterial_T CASCADE;
DROP TABLE Territory_T CASCADE;
DROP TABLE Employee_T CASCADE;
...
VALUES  (1001, '21/Oct/18', 1);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1002, '21/Oct/18', 8);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1003, '22/Oct/18', 15);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1004, '22/Oct/18', 5);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1005, '24/Oct/18', 3);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1006, '24/Oct/18', 2);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1007, '27/Oct/18', 11);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1008, '30/Oct/18', 12);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1009, '05/Nov/18', 4);
INSERT INTO Order_T  (OrderID, OrderDate, CustomerID)
VALUES  (1010, '05/Nov/18', 1);
