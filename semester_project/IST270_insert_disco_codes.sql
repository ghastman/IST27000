-- SELECT * FROM ist270.disconnect_codes;

INSERT IGNORE INTO `ist270`.`disconnect_codes` (
 	 `id`
    ,`name`
    ,`description`
) 
...
,(494, 'Security Agreement Required', 'The server has received a request that requires a negotiated security mechanism, and the response contains a list of suitable security mechanisms for the requester to choose between.')
